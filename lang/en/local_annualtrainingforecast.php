...
$string['annualtrainingforecast'] = 'Annual Training Forecast';

// Capabilities
$string['annualtrainingforecast:managecourses'] = 'Manage annual training courses';
$string['annualtrainingforecast:viewreports'] = 'View annual training reports';
...
$string['courseduration_help'] = 'Enter the duration of the course in days';
...
$string['nodata'] = 'No data available for the Gantt chart.';

// Export
$string['pdfexport'] = 'PDF Export';
$string['annualtraininggantt'] = 'Annual Training Gantt Chart';
